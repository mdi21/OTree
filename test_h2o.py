...
if __name__ == '__main__':
    ...
    o, list1, list2 = init_dot('Quelques fichiers de test-20221116/Molécules/H2O.dot', threshold)
    o.subdivide3d()
    ...
    print("création du fichier calcule nouvelles positions H2O")
    # Ouvrir un fichier pour écrire les résultats
    f = open('resultats/calcule_nouvelles_positions_H2O.txt', 'w')
    ...
    print("fin de création du fichier calcule nouvelles positions H2O")
